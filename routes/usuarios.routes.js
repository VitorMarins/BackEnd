 ...
 *   get:
 *     summary: Retorna os seguidores de um usuário específico
 *     tags: [Usuarios]
 *     security:
 *       - bearerAuth: []  # Especifica que a autenticação é necessária
 *     parameters:
 ...
 *         in: path
 *         required: true
 *         description: ID do usuário cujos seguidores serão retornados
 *         schema:
 *           type: string
 *     responses:
 *       200:
 *         description: Lista de seguidores do usuário
 *       404:
 *         description: Usuário não encontrado
 *       500:
 *         description: Erro interno do servidor
 */
router.get('/seguidores/:id', authMiddleware, getSeguidorByUsuarioId);
